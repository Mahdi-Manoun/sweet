(function($) {
 ...
 $(document).ready(function() {
  $('.countdown-timer').countdown({
    date: '1/2/2022 23:59:59', // Target date and time for the countdown
    offset: +2, // Your timezone offset
    day: 'Day', // Label for a single day
    days: 'Days', // Label for multiple days
    hideOnComplete: true // Hide the countdown when completed
  });
});
